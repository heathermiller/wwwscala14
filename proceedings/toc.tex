...
\vspace{0.5cm}
\large \textbf{Scala Workshop 2014 Organization} \cftdotfill 0 v
\normalsize
...
Aleksandar Prokopec {\em(EPFL)}, Philipp Haller {\em(Typesafe Switzerland)}, Martin Odersky {\em(EPFL)}
...
\item {\bf Towards Virtual Traits in Scala} \cftdotfill 067\\
